...
- `.\gradlew.bat test` — 单元测试（全模块 `src/test`；当前 **1257 例：1244 通过 / 0 失败 / 13 跳过**，分布 app 678 / core 58 / **crypto 107** / **database 235** / sync 179，其中 12 例跳过项需 `-DliveSyncTest` 才启用，1 例为 Windows 无 POSIX 权限视图的缓存权限断言）
