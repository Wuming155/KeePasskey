...
> **2026-09-10 追加**：**ISSUE-P3-30 已闭环并归档**（子库条目只读投影接入库列表，见 §5），
> 本节余 **3 项**（P3-23 / P3-24 / P3-29）。
...
> （该源集已建立并接线），已在条目内就地标注；P3-24 / P3-29 前提完整成立。
...
- **验收标准（未来分批）**：
  ...
  3. 每批拆分为**纯结构性**改动：`.\gradlew.bat test` 全绿且用例数不减（当前 **1200 例**）；
