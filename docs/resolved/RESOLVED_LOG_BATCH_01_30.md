# KeePasskey 已整改问题与历史归档 · 分册 01（§1 ~ §30）

> **分册定位**：本册是 [RESOLVED_LOG.md](../RESOLVED_LOG.md) 的历史分册，收录 **§1 ~ §30** 全量正文（2026-09-07 ~ 2026-09-12 批次）。
> **主文件职责**：RESOLVED_LOG.md 只保留全量批次索引与最近 10 个批次（当前 §58 ~ §67）正文；新批次先写入主文件，满额后按序下沉分册。
> **引用定位**：仓内其它文档的「RESOLVED_LOG.md §NN」引用，凡 NN 落在 §1 ~ §30 区间，正文即本册对应小节（可用本册索引跳转）。
...
| 章节 | 批次 | 条目范围 |
|---|---|---|
| [§1](#s1) | 已完成核心任务 | `TASK-01` ~ `TASK-53` |
| [§2](#s2) | 历史全量代码审计（93 项 + 4 类专项 + ZT/P1/P2 逐项） | 2.1 ~ 2.22 |
| [§3](#s3) | P3 批次（16 项） | ISSUE-P3-01 ~ P3-16 |
| [§4](#s4) | P3 残余批次（12 项） | ISSUE-P3-17 ~ P3-28 |
| [§5](#s5) | P3-30 单条（子库条目只读投影） | ISSUE-P3-30 |
| [§6](#s6) | P3-29 批次 A（全仓超阈值债务） | ISSUE-P3-29 |
| [§7](#s7) | CI 首跑实测整改（lint / CodeQL / 供应链闸门） | ISSUE-P3-32 |
| [§8](#s8) | 原生内核扩展与工程化（AES-KDF / Twofish / 口令强度 / HMAC / 语料） | ISSUE-P3-34 ~ P3-38 |
| [§9](#s9) | 自动填充能力对标 | ISSUE-P3-39 ~ P3-45 |
| [§10](#s10) | P3-31 批次 B（超阈值债务） | ISSUE-P3-31 |
| [§11](#s11) | P3-31 批次 C + P3-43 闭环 | ISSUE-P3-31 / P3-43 |
| [§12](#s12) | P3-31 批次 D + P3-46 闭环 | ISSUE-P3-31 / P3-46 |
| [§13](#s13) | P3-31 批次 E（超阈值债务） | ISSUE-P3-31 |
| [§14](#s14) | P3-31 批次 F（超阈值债务） | ISSUE-P3-31 |
| [§15](#s15) | P3-31 批次 G（超阈值债务） | ISSUE-P3-31 |
| [§16](#s16) | P3-31 批次 H（超阈值债务） | ISSUE-P3-31 |
| [§17](#s17) | P3-31 批次 I（超阈值债务 · **本条闭环**） | ISSUE-P3-31 |
| [§18](#s18) | CI Fast gate 偶发红根因修复（测试调度器污染） | 测试基础设施 |
| [§19](#s19) | dependency-scan CI 侧首跑留痕 + 断言可观测性修复 | ISSUE-P3-24 / P3-32 |
| [§20](#s20) | 功能完整性审计批次 A（全文搜索范围 / 详情页单条删除） | ISSUE-P3-47 / P3-48 |
| [§21](#s21) | 功能完整性审计批次 B（HOTP 端到端 / 便利入口 / 孤儿实现清理） | ISSUE-P3-49 / P3-50 / P3-51 |
| [§22](#s22) | 存量问题由易到难整改闭环批次（P1-11 / P2-17 / P2-18 / P3-52~P3-56） | ISSUE-P1-11 / P2-17 / P2-18 / P3-52 ~ P3-56 |
| [§23](#s23) | CI 侧真实跑通归档 + CodeQL Rust 误报治理（P3-24 / P3-32 / P3-57 闭环） | ISSUE-P3-24 / P3-32 / P3-57 |
| [§24](#s24) | 设备侧实测发现的致命缺陷修复（Android 端 KDBX XML 解析全量失败） | ISSUE-P1-12 |
| [§25](#s25) | 设备侧互操作语料入库与端到端解锁跑绿（真实 KeePassXC `.kdbx`） | ISSUE-P3-23 |
| [§26](#s26) | 设备侧手工实操发现的 P0 崩溃修复（字段引用正则在 Android ICU 上非法） | ISSUE-P0-04 |
| [§27](#s27) | 设备侧功能实测收口 + 9 项缺陷整改（2026-09-11） | 见 §27 |
| [§28](#s28) | 存量问题修复批次（快捷脱敏 / 关闭校验 / 外部存储清理） | ISSUE-P2-22 / P3-63 / P3-65 / P3-67 |
| [§29](#s29) | 用户报告修复批次（复合封印指纹解锁 / 重试节流可配置 / FLAG_SECURE 语义修订） | ISSUE-P2-23 / P3-68 |
| [§30](#s30) | 外部安全审计核实与整改批次（Wrapper 哈希 / 字节清零 / 扫码防截屏 / 许可证注释） | ISSUE-P3-69 ~ P3-72 |
