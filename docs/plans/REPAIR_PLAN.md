...
| 4 | **TASK-49** | 特性 | 图标渲染 / 删除 + 引用展示侧残余接线 | ❌ | P3 | 数据通道已就绪，消费点平移 |

> 上表「STATUS 状态」为 2026-09-09 快照引用，实时状态一律以 `STATUS.md` §2 为准。TASK-44 / TASK-47 / TASK-48 已先后落地并随代码提交回写 `STATUS.md` §2，规划段落已删除；TASK-45 / TASK-20 此前已落地（见各自提交 `d4bc46c` / `c530761`）。
