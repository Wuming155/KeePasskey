...
**⑤ 第一轮有一处 10+ 条线索的"复核真空"，本轮首次补上。**
`RESOLVED_LOG` §43.5 自述待复核区（`IPC-01…IPC-11`、`SUPPLY-01…SUPPLY-08`）"**未经首席审计员逐条复核**"，
而第一轮**只做了归并**（转成三条待办），**从未给出任何"成立/不成立"结论**。本轮已逐条补齐（§6.8）。
...
| `SYS-2` | **待复核区被"归并待办"替代复核** | §43.5 自认"未经逐条复核" | 10+ 条线索从未获结论（本轮补上） |
...
（`P3-79`/`P3-90`/`P3-91`/`P2-66`/`IPC-05`/`P3-124`）与 `IPC-0x`/`SUPPLY-0x` 逐条结论。
